...
|-------|--------|---------|
| Bronze | `bronze_databricks_` | `bronze_databricks_transactions` |
| Silver | `silver_databricks_` | `silver_databricks_customers` |
| Gold | `gold_databricks_` | `gold_databricks_daily_revenue` |
